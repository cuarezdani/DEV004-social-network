...
var wa = x$1("Opera"), y = x$1("Trident") || x$1("MSIE"), xa = x$1("Edge"), ya = xa || y, za = x$1("Gecko") && !(-1 != sa().toLowerCase().indexOf("webkit") && !x$1("Edge")) && !(x$1("Trident") || x$1("MSIE")) && !x$1("Edge"), Aa = -1 != sa().toLowerCase().indexOf("webkit") && !x$1("Edge");
function Ba() {
  var a = l.document;
...
const rootDiv$1 = document.getElementById("root");
const onNavigate = (pathname) => {
  ...
  if (rootDiv$1.firstChild) {
    rootDiv$1.removeChild(rootDiv$1.firstChild);
  }
  rootDiv$1.appendChild(routes[pathname]());
};
const Home = () => {
...
const Login = () => {
  ...
  const lineaOr = document.createElement("h5");
